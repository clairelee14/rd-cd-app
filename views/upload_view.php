    ...
    <!-- in this example, we are incorporating another form field (validated) just to show how its done. The title is not saved anywhere. IIn an actual app, you will save all this info in your DB -->
